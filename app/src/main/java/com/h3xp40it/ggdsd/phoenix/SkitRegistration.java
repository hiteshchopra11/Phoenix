...
public class SkitRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skit_registration);
        enterotpdisable();
        TextView txt = findViewById(R.id.textBox);
        txt.setText("" + "Skit Registration");
        registerDisable();
        findViews();
        StartFirebaseLogin();
            ...
            public void onClick(View v) {
                if (haveNetworkConnection()) {
                    ...
                    if (isEmpty(college) || isEmpty(oneContestant) || isEmpty(twoContestant) || isEmpty(threeContestant) || isEmpty(fourContestant) || isEmpty(fiveContestant) || isEmpty(contact)) {
                        if (isEmpty(college)) {
                            Toast.makeText(SkitRegistration.this, "Please enter college name", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(SkitRegistration.this, "Please enter atleast 5 names", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(SkitRegistration.this, "Please enter contact number", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                ...
                                SkitRegistration.this,         // Activity (for callback binding)
                                mCallback);
                    }
                } else
                    Toast.makeText(SkitRegistration.this, "Please connect to the internet", Toast.LENGTH_SHORT).show();
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isEmpty(etOTP)) {
                    Toast.makeText(SkitRegistration.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            EmailIntentBuilder.from(SkitRegistration.this)
                            ...
                            Toast.makeText(SkitRegistration.this, "You have entered an incorrect OTP", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void StartFirebaseLogin() {
        ...
        mCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                ...
                EditText sixContestant = findViewById(R.id.contestantSix);
                EditText contact = findViewById(R.id.et_phone_number);
                Toast.makeText(SkitRegistration.this, "OTP verified", Toast.LENGTH_SHORT).show();
                String subject = "Skit";
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                //Toast.makeText(SkitRegistration.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                String tmp = "Some error occured.";

                if (tmp.contains("TOO_SHORT")) {
                    Toast.makeText(SkitRegistration.this, "The number entered is too short.", Toast.LENGTH_SHORT).show();
                } else if (tmp.contains("TOO_LONG")) {
                    Toast.makeText(SkitRegistration.this, "The number entered is too long.", Toast.LENGTH_SHORT).show();
                } else if (tmp.contains("Invalid format")) {
                    Toast.makeText(SkitRegistration.this, "Invalid format", Toast.LENGTH_SHORT).show();
                } else
                    Toast.makeText(SkitRegistration.this, tmp, Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken
                ...
                verificationCode = s;
                Toast.makeText(SkitRegistration.this, "Code sent", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    public void back(View view) {
        Intent intent = new Intent(SkitRegistration.this, Skit.class);
