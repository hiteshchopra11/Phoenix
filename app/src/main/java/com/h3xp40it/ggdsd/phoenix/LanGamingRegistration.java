...
public class LanGamingRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lan_gaming_registration);
        enterotpdisable();
        TextView txt = findViewById(R.id.textBox);
        txt.setText("" + "LAN Gaming Registration");
        registerDisable();
        findViews();
        StartFirebaseLogin();
            ...
            public void onClick(View v) {
                if (haveNetworkConnection()) {
                    ...
                    if (isEmpty(college) || isEmpty(oneContestant) || isEmpty(twoContestant) || isEmpty(threeContestant) || isEmpty(fourContestant) || isEmpty(fiveContestant) || isEmpty(contact)) {
                        if (isEmpty(college)) {
                            Toast.makeText(LanGamingRegistration.this, "Please enter college name", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(LanGamingRegistration.this, "Please enter 5 names", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(LanGamingRegistration.this, "Please enter contact number", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                ...
                                LanGamingRegistration.this,         // Activity (for callback binding)
                                mCallback);
                    }
                } else
                    Toast.makeText(LanGamingRegistration.this, "Please connect to the internet", Toast.LENGTH_SHORT).show();
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isEmpty(etOTP)) {
                    Toast.makeText(LanGamingRegistration.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            EmailIntentBuilder.from(LanGamingRegistration.this)
                            ...
                            Toast.makeText(LanGamingRegistration.this, "You have entered an incorrect OTP", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void StartFirebaseLogin() {
        ...
        mCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                ...
                EditText fiveContestant = findViewById(R.id.contestantFive);
                EditText contact = findViewById(R.id.et_phone_number);
                Toast.makeText(LanGamingRegistration.this, "OTP verified", Toast.LENGTH_SHORT).show();
                String subject = "LAN Gaming";
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                //Toast.makeText(LanGamingRegistration.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                String tmp = "Some error occured.";

                if (tmp.contains("TOO_SHORT")) {
                    Toast.makeText(LanGamingRegistration.this, "The number entered is too short.", Toast.LENGTH_SHORT).show();
                }

                else if (tmp.contains("TOO_LONG")) {
                    Toast.makeText(LanGamingRegistration.this, "The number entered is too long.", Toast.LENGTH_SHORT).show();
                }

                else if (tmp.contains("Invalid format")) {
                    Toast.makeText(LanGamingRegistration.this, "Invalid format", Toast.LENGTH_SHORT).show();
                } else
                    Toast.makeText(LanGamingRegistration.this, tmp, Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken
                ...
                verificationCode = s;
                Toast.makeText(LanGamingRegistration.this, "Code sent", Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    public void back(View view) {
        Intent intent = new Intent(LanGamingRegistration.this, LanGaming.class);
